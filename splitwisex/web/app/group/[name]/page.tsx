    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="bg-red-900 text-white relative h-48">
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <h1 className="text-3xl font-medium">{g.name || `Group #${g.id}`}</h1>
        ...
        <div className="flex flex-col items-center justify-center flex-1 pt-4">
          {/* Heart icon */}
          <div className="w-24 h-24 bg-white rounded-lg p-2 shadow-md flex items-center justify-center mb-4">
          ...
          {/* Group name below icon */}
          <h2 className="text-3xl font-bold text-white text-center">{g.name || `Group #${g.id}`}</h2>
        </div>
      </div>
